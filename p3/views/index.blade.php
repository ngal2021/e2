...
@section('content')
    ...
    @if ($result)
        ...
        @if ($playerMove)
            ...
            You threw <b><span test='player-move'>{{ $playerMove }}</span></b>, the computer threw
            <b><span test='computer-move'>{{ $computerMove }}</span>.</b>
            ...
            @elseif ($won)
                ...
                <span test='won-output' class='won'>Congrats, you won!
                    {{ ucfirst($playerMove) }} beats
                    {{ $computerMove }}.
                </span>

            @else

                <span test='lost-output' class='lost'>Sorry, you lost!
                    {{ ucfirst($playerMove) }} is beaten by {{ $computerMove }}.
                </span>
    ...
    <div class='row text-center'>
        ...
        <p>
            ...
            or
            <a test='statistics-nav' href='/statistics'>game statistics</a>.
        </p>
